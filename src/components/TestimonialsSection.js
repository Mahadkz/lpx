...
function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote: "Phi isn't just a service provider—they became our on-demand revenue team. Within weeks, we saw a complete turnaround in our outbound motion.",
      ...
      <div className="testimonial-container">
        ...
        <div className="brands-trust-section">
          ...
          <div className="trust-cta-container">
            <a href="https://calendly.com/raza-rehman/modern_outbound_jam" className="cta-button trust-cta">
