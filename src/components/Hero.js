    ...
    <section className="hero-section">
      ...
      <div className="hero-container">
        <div className="hero-content">
          <div className="hero-badge">RESULTS-DRIVEN GTM GROWTH</div>

          <h1 className="hero-title">
            <span className="title-line">You Built</span>
            <span className="title-line">
              <span className="title-highlight">the Tech.</span>
            </span>
            <span className="title-line">We Build</span>
            <span className="title-line">
              <span className="title-highlight">the Pipeline.</span>
            </span>
          </h1>

          <p className="hero-subtitle">
            We help <strong>Logistics & Supply Chain</strong> startups{" "}
            <strong>scale faster</strong> and <strong>reduce CAC</strong> with
            specialist freight GTM sales talent that deliver qualified pipeline
            in as little as <strong>21 days</strong>.
          </p>
          ...
          <div className="hero-metrics">
            ...
            <div className="metric-item">
              <span className="metric-value revenue-text">$300M+</span>
