...
function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzQWiinYu35iVh97zHP6Sc2Gm6JwSbGxEg5AJIQIZGq1q-zA8mmMOQCFnOdNNYKsQnv/exec';
  ...
  return (
    <div className="contact-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <span>{isSubmitting ? 'Sending...' : 'Get Your Pipeline Strategy'}</span>
        ...
        {submitStatus === 'success' && (
          <p style={{color: 'green', textAlign: 'center', marginTop: '15px', fontWeight: '500'}}>
      ...
      <div className="form-testimonial">
        ...
        <div className="testimonial-quote">"$14M revenue increase in the first year."</div>
        <div className="testimonial-author">— FleetTech CEO</div>
      </div>
    </div>
  );
}
